		...
		include "koneksi/config.php";
        $query3   = "SELECT  COUNT(ID_POST) AS jumData FROM posting WHERE ID_KAT=2";
          ...
          if ($jumData > 5)
            {
              ...
              echo  "<a href='?page=front/web_design&p=".($noPage-1)."'><button class='primary-button-1 center-block'>Prev</button></a>";
              ...
              for($page = 1; $page <= $jumPage; $page++)
              {
                ...
                if ((($page >= $noPage - 3) && ($page <= $noPage + 3)) || ($page == 1) || ($page == $jumPage))
                {
                  ...
                  else echo "<a href='?page=front/web_design&p=".$page."'><button class='primary-button-1 center-block'>".$page."</button></a>";
                }
              }
              ...
              if ($noPage < $jumPage) 
              echo "<a href='?page=front/web_design&p=".($noPage+1)."'><button class='primary-button-1 center-block'>Next</button></a>";
            }
