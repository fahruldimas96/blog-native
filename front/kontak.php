					...
					<div class="row">
						<div class="col-md-6">
							<div class="section-row">
								...
								<p>
									<center><label style="color: blue; font:20px Time New Roman; width=30%">Fahrul Dimas Saputra</label></center>
								</p>
								...
								<p>
									<h3>Riwayat Pengalaman Kerja</h3>
								</p>
								...
								<ul class="list-style">
									<li>
										<p><strong>Email:</strong> <a href="#">fahrul.dimassaputra@gmail.com</a></p>
									</li>
									<li>
										<p><strong>Phone:</strong> 0812-9618-8831</p>
									</li>
									<li>
										<p><strong>Address:</strong> Jakarta Timur</p>
									</li>
								</ul>
							</div>
						</div>
