				...
				<!-- row -->
						...
						<div class="row">
							...
							<?php  
					  		...
					  		$query = "SELECT * FROM posting, kategori, user WHERE posting.ID_KAT=3 AND kategori.ID_KAT=posting.ID_KAT AND user.ID_ADMIN=posting.ID_ADMIN ORDER BY ID_POST DESC LIMIT $offset, $dataPerPage";
